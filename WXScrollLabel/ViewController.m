...
- (void)setupScrollLabel{
    ...
    //array
    WXCyclicScrollLabel *arrayScrollLabel = [WXCyclicScrollLabel scrollLabelTextArray:@[@"1111111", @"222222", @"3333333"] type:WXScrollTypeLeftRight velocity:0.5 option:UIViewAnimationOptionCurveEaseInOut font:[UIFont systemFontOfSize:12] scrollSpace:10 insets:UIEdgeInsetsMake(0, 10 , 0, 10)];
    ...
    WXCyclicScrollLabel *arrayUpdownScrollLabel = [WXCyclicScrollLabel scrollLabelTextArray:@[@"444444", @"555555", @"6666666"] type:WXScrollTypeUpDown velocity:1 option:UIViewAnimationOptionCurveEaseInOut font:[UIFont systemFontOfSize:12] scrollSpace:10 insets:UIEdgeInsetsMake(0, 10 , 0, 10)];
    arrayUpdownScrollLabel.frame = CGRectMake(10, 350, 300, 30);
    arrayUpdownScrollLabel.scrollLabelDelegate = self;
    [self.view addSubview:arrayUpdownScrollLabel];
    [arrayUpdownScrollLabel beginScrolling];
